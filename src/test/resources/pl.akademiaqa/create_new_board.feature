Feature: Create new board
  ...
  @cleanup
  Scenario Outline: I should be able to create new board with special characters as board name
    Given I am authenticated to Trello
  ...
  Scenario: I should not be able to create new board with empty name
    Given I am authenticated to Trello

...
public class CreateBoardSteps {
    ...
    @When("I create new board with name {string}")
    public void i_create_new_board_with_name(String boardName) {
        createNewBoard(boardName);
    }

    @When("I create new board with empty board name")
    public void i_create_new_board_with_empty_board_name() {
        requestHandler.setEndpoint(TrelloUrl.BOARDS);
        requestHandler.addQueryParam("name", CommonValues.EMPTY_BOARD_NAME);
